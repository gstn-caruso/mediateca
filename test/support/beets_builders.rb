...
module BeetsBuilders
  ...
  def beets_album(
    ...
    Music::Source::Album.new(beets_id:, title:, artist:, year:, genre:, album_type:, disc_total:, cover_path:, tracks:)
  end
  ...
  def beets_track(
    ...
    Music::Source::Track.new(beets_id:, title:, track_no:, disc_no:, duration:, path:)
  end
end
